...
public class CheeseCrop extends CropsBlock
{
    public static final IntegerProperty CHEESE_AGE = BlockStateProperties.AGE_0_2;
    ...
    public CheeseCrop(AbstractBlock.Properties properties) {
        super(properties);
    }
