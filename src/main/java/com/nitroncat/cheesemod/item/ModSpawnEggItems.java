...
{
    protected static final List<ModSpawnEggItems> MOD_EGGS = new ArrayList<>();

    private final Lazy<? extends EntityType<?>> entityTypeSupplier;

    public ModSpawnEggItems(final RegistryObject<? extends EntityType<?>> entitySupplier, int primaryColorIn,
    ...
    public static void initSpawnEgs()
    {
        ...
        for (final SpawnEggItem spawnEgg : ModSpawnEggItems.MOD_EGGS)
        {
            EGGS.put(spawnEgg.getType(null), spawnEgg);
            DispenserBlock.registerDispenseBehavior(spawnEgg, dispenseItemBehavior);
        }
        ModSpawnEggItems.MOD_EGGS.clear();
    }
